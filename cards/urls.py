...
urlpatterns = [
    ...
    path('start/<slug:card_type>/', views.start_free, name='start_free'),
    ...
    path('my-admin/offers/', views.admin_offers, name='admin_offers'),
    path('my-admin/offers/save/', views.admin_offer_save, name='admin_offer_create'),
    path('my-admin/offers/<int:offer_id>/save/', views.admin_offer_save, name='admin_offer_edit'),
    path('my-admin/offers/<int:offer_id>/toggle/', views.admin_offer_toggle, name='admin_offer_toggle'),
    path('my-admin/offers/<int:offer_id>/delete/', views.admin_offer_delete, name='admin_offer_delete'),
