...
urlpatterns = [
    ...
    path('card/<slug:unique_slug>/', views.view_card, name='view_card'),
    path('card/<slug:unique_slug>/edit/', views.edit_card, name='edit_card'),
    ...
    path('my-admin/card/<slug:unique_slug>/delete/', views.delete_card_admin, name='delete_card_admin'),
